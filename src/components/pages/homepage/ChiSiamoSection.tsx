...
const ChiSiamoSection = () => {
  return (
    <section id="chi-siamo" className="bg-accent-primary py-20 md:py-0 ">
      <div className="container mx-auto px-4 flex flex-col-reverse items-center gap-10 md:flex-row md:gap-16">
        ...
        <div className="md:w-1/2 text-center md:text-left space-y-6">
          ...
          <p className=" text-lg leading-relaxed font-nunito font-light">
            ...
            in piatti della tradizione mediterranea. Da anni portiamo in tavola
            sapori autentici, ingredienti freschi e tanta passione.
          </p>
          <p className=" text-lg leading-relaxed font-nunito font-light">
